...
规格标识（仓库名）：`10.1-tft-800x1280-mipi-jd9366`
...
| Raspberry Pi 5 · JD9366 显示 + 触摸 · LVGL9 运行示例 | [`examples/rpi5-lvgl-jd9366-touch-800x1280/`](./examples/rpi5-lvgl-jd9366-touch-800x1280/) |

## 仓库结构

```text
10.1-tft-800x1280-mipi-jd9366/                                # 仓库根（导航见 ../../README.md）
└── versions/
...
- [Raspberry Pi 5 JD9366 显示 + 触摸 · LVGL9](./examples/rpi5-lvgl-jd9366-touch-800x1280/)
